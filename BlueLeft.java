...
public class BlueLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ContourPipelineBlue myPipeline = new ContourPipelineBlue();
        ...
        while(!opModeIsActive()){
            ...
            telemetry.addData("tick: ", tickMark);
        ...
        if(tickMark == 3){//-------------------------------------------------------Right Mark---------------------------------------
            ...
            sleep(200);
            pivotLeft(startHeading+45);//right
            sleep(200);
            spit();//drop
            sleep(200);
            odo(11, X_MULTIPLIER, 1, startHeading+45);//forward

            sleep(200);
            turnLeft(startHeading+90);//right
            sleep(200);
            ...
            sleep(200);
            strafe(15, Y_MULTIPLIER, -1, startHeading);
            sleep(200);
            odo(8.5, X_MULTIPLIER, 1, startHeading);
        ...
        if(tickMark == 1){ //--------------------------------------------------------------Left mark--------------------
            ...
            odo(31, X_MULTIPLIER, 1, startHeading);//forward
            sleep(200);
            pivotRight(startHeading-50);

            sleep(200);
            spit();//drop
            sleep(200);

            odo(5, X_MULTIPLIER, 1, startHeading-50);//forward

            sleep(200);
            turnLeft(startHeading);
            sleep(200);
            odo(10, X_MULTIPLIER, 1, startHeading);//forward
            sleep(200);
            turnLeft(startHeading+90);

            sleep(200);
            startHeading = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES).firstAngle;//reset straight angle
            startHeading = (startHeading < 0) ? 360 + startHeading : startHeading;//reset straight angle

            odo(55, X_MULTIPLIER, 1, startHeading);//forward
            ...
            odo(13.5, X_MULTIPLIER, 1, startHeading);
            sleep(200);
            slides(1250, 1);
            drop();
            sleep(300);
        ...
        if(tickMark == 2){//------------------------------------------------------Middle Mark----------------------------------------------
            ...
            odo(65, X_MULTIPLIER, 1, startHeading);//forward
            ...
            odo(4.2, X_MULTIPLIER, 1, startHeading);
            sleep(100);
            slides(1100, 1);
            drop();
            sleep(300);
            slides(300, -1);
            strafe(18, Y_MULTIPLIER, 1, startHeading);
        ...
        //odo(23, X_MULTIPLIER);
        //sleep(300);
        //turnLeft(startHeading+89-360, 4);
        //spit();
    ...
    public void odo(double dist, double tickstoinch, int reverse, double straightHeading){
        ...
        while (Math.abs(xAxis.getCurrentPosition()) < ticks){
            ...
            rightFront.setPower(reverse*(0.8*output + fix));
            leftFront.setPower(reverse*(0.7*output - fix));
            leftRear.setPower(reverse*(0.7*output  - fix));
            rightRear.setPower(reverse*(0.8*output + fix));
