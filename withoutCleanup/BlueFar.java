...
public class BlueFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(tickMark == 3){//-------------------------------------------------------Right Mark---------------------------------------
            ...
            sleep(200);
            pivotLeft(startHeading+45, 1);//right
            sleep(200);
            spit();//drop
            sleep(200);
            ...
            sleep(200);
            strafe(13, Y_MULTIPLIER, -1, startHeading);
            sleep(200);
            odo(6, X_MULTIPLIER, 1, startHeading);
        ...
        if(tickMark == 1){ //--------------------------------------------------------------Left mark--------------------
            ...
            odo(62, X_MULTIPLIER, 1, startHeading);//forward

            sleep(200);
            strafe(29, Y_MULTIPLIER, -1, startHeading);
            sleep(200);


            odo(7.2, X_MULTIPLIER, 1, startHeading);
            sleep(200);
            slides(1350, 1);
            drop();
            sleep(300);
            ...
            strafe(26, Y_MULTIPLIER, 1, startHeading);
        ...
        if(tickMark == 2){//------------------------------------------------------Middle Mark----------------------------------------------
            ...
            odo(34.4, X_MULTIPLIER, 1, startHeading);//forward
            sleep(200);
            spit();
            sleep(200);
            odo(12, X_MULTIPLIER, 1, startHeading);//forward
            ...
            odo(64, X_MULTIPLIER, 1, startHeading);//forward

            sleep(200);

            strafe(19.4, Y_MULTIPLIER, -1, startHeading);
            sleep(200);

            odo(3.3, X_MULTIPLIER, 1, startHeading);
            sleep(100);
            slides(1100, 1);
            drop();
            sleep(300);
