    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!opModeIsActive()) {
            ...
            if(gamepad1.right_bumper){
                myPipeline.scalarLowerBGR.val[2] += 10;
                sleep(100);
            }
            ...
            if(gamepad1.cross){
                myPipeline.scalarUpperBGR.val[2] += 10;
                sleep(100);
            ...
            if(gamepad1.square){
                myPipeline.scalarUpperBGR.val[0] += 10;
                sleep(100);
        ...
        if (tickMark == 3) {
            sleep(200);
            pivotLeft(startHeading + 90, 1);//pivot right
            sleep(200);



            odo(1, X_MULTIPLIER, 1, startHeading+90);//forward
            sleep(200);
            ...
            odo(29.5, X_MULTIPLIER, 1, startHeading+90);//forward
            sleep(200);
            //-------------------------------------------------------Creep Up
            ...
            sleep(200);
            //---------------------------------------------------------COLOR Strafe
            colorStrafe(2.5,Y_MULTIPLIER,1,startHeading+90,tagScanner.alpha() > 70);
            sleep(200);
            ...
            strafe(23,Y_MULTIPLIER,-1,startHeading+90);
            sleep(200);
        ...
        if (tickMark == 2) {
            odo(3, X_MULTIPLIER, 1, startHeading);//forward

            sleep(200);
            turnRight(startHeading-180);//flip 180
            sleep(200);

            odo(9, X_MULTIPLIER, 1, startHeading-180);//forward
            sleep(200);

            spit();//drop
            sleep(200);

            odo(6.5, X_MULTIPLIER, 1, startHeading-180);//forward
            sleep(200);

            turnRight(startHeading+90);//face the board
            sleep(200);

            odo(16, X_MULTIPLIER, 1, startHeading + 90);//forward
            sleep(200);
            //-------------------------------------------------------Creep Up-------------------------------------
            distance(4.5, startHeading+90);
            sleep(200);
        ...
        if (tickMark == 1) {
            ...
            odo(13, X_MULTIPLIER, 1, startHeading+90);//forward
            sleep(200);
            //-------------------------------------------------------Creep Up
            distance(4.5, startHeading+90);
            sleep(200);
            //----------------------------------------------------TAG SCAN???
            colorStrafe(6,Y_MULTIPLIER,-1,startHeading+90, tagScanner.argb() < 180000000 );
            sleep(200);
